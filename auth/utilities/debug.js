...
/**
 * debuggin module to print info in command
 * log:-
 *     parameter:- print params of object
 *     functionName:- print exicuted function name
 *     variable:- print variable data
 *     request:- print request info
 */
module.exports = {
  levels,
  setLevel: (l) => (level = l),
