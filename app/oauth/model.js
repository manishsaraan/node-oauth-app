// visit https://oauth2-server.readthedocs.io/en/latest/model/spec.html for what you can do with this
const db = {
  // This is in memory saving of token, you must use your own database model here
  authorizationCode: {
...
module.exports = {
  getClient: function (clientId, clientSecret) {
    ...
    db.client = {
      ...
      redirectUris: ['https://oauth-app-2.herokuapp.com/client/app'],
    };
